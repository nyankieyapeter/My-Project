<!--Edit Modal -->
<div class="modal fade custom-modal" id="createProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
     ...
     <form action="{{ route('product.store', ['store' => session('selected_store')]) }}"
           method="POST">
         @csrf
