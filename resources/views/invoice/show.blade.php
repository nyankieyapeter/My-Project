...
<body>
        ...
        <span style="float: right;margin-bottom:12px">
            <a href="{{ route('pos.index', ['store' => session('selected_store')]) }}" class="btn btn-primary btn-sm">Return Back to Pos</a>
            <a href="{{ route('invoice.print', ['store' => session('selected_store'), 'invoice' => $order->id]) }}" class="btn btn-primary btn-sm">Print</a>
        </span>
