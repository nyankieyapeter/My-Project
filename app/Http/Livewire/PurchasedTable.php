...
final class PurchasedTable extends PowerGridComponent
{
    use ActionButton;
    use WithExport;
    ...
    */
    ...
    public function datasource(): Builder
    {
        ...
        $selectedStoreName = $this->storeMapping[$selectedStoreKey] ?? null;

        if ($selectedStoreName) {
            return Purchased::where('store', $selectedStoreName);
        }

        return Purchased::query()->where('id', '=', null);
    }
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Purchased at', 'created_at_formatted', 'created_at')
                ->sortable(),
