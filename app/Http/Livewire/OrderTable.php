...
final class OrderTable extends PowerGridComponent
{
    ...
    */
    ...
    public function datasource(): Builder
    {
        ...
        // Get the selected store key from the session
        $selectedStoreKey = session('selected_store');

        // Use the data mapping to get the store name based on the selected store key
        $storeName = $this->storeMapping[$selectedStoreKey] ?? null;

        if ($storeName) {
           // Create an Eloquent Builder for the Order model
           $query = Order::query();

           $query->whereHas('store', function (Builder $storeQuery) use ($storeName) {
    ...
    */
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            /* ->addColumn('id') */
            ->addColumn('order_invoice')

           /** Example of custom column using a closure **/
            ->addColumn('order_invoice_lower', fn (Order $model) => strtolower(e($model->order_invoice)))
    ...
    */
    ...
    public function columns(): array
    {
        return [
            /* Column::make('Id', 'id'), */
            Column::make('Order invoice', 'order_invoice')
                ->sortable()
                ->searchable(),
            ...
            Column::make('Date Processed', 'created_at_formatted', 'created_at')
                ->sortable(),
    ...
    {
        return [
            Filter::inputText('order_invoice')->operators(['contains']),
            ...
            Filter::inputText('store_id')->operators(['contains']),
